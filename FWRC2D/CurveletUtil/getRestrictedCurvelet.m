function [rCurvelets,non_rCurvelets,allCurveletAnglesInfo] = getRestrictedCurvelet(cs_transform)
...
%restrictType = cs_transform.restrictType;

% compute the Curvelet mask 
CMask = fdct_wrapping(zeros(imageSize),1,1,nscales,nangles_coarse,imageSize(1),imageSize(2));
